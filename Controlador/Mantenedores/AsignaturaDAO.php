...
class AsignaturaDAO {
    ...
    public function findAsigAndProgBasicoByM_id_And_asig_periodo($m_id,$asig_periodo) {
        ...
        while ($fila = $result->fetch_row()) {
            ...
            $programa_basico->setPb_tipo_curso(utf8_encode($fila[7]));
            $programa_basico->setPb_carrera(utf8_encode($fila[8]));
            $programa_basico->setPb_departamento(utf8_encode($fila[9]));
            $programa_basico->setPb_facultad(utf8_encode($fila[10]));
