                                    ...
                                    <div class="box-body">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="pb_presentacion" name="pb_presentacion" rows="14" class="form-control" value="<?= $programa_basico->getPb_presentacion() ?>"></textarea>
