            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Crear Programa Guia Didáctico</li>
                    </ol>
                </section>
                                            ...
                                            <div class="group-resultado">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">   
                                                        ...
                                                        <textarea id="dpd_actividad_aprendizaje_<?= $i ?>" name="dpd_actividad_aprendizaje_<?= $i ?>" rows="20" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">   
                                                        ...
                                                        <textarea id="dpd_mediacion_ensenianza_<?= $i ?>" name="dpd_mediacion_ensenianza_<?= $i ?>" rows="20" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">   
                                                        ...
                                                        <textarea id="dpd_actividad_evaluacion_<?= $i ?>" name="dpd_actividad_evaluacion_<?= $i ?>" rows="19" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">   
                                                        ...
                                                        <textarea id="dpd_recurso_didactivo_<?= $i ?>" name="dpd_recurso_didactivo_<?= $i ?>" rows="19" class="form-control"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="label-group-resultado">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control pull-right" id="dpd_hp_ht_<?= $i ?>" name="dpd_hp_ht_<?= $i ?>" min="0">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="dpd_hp_hp_<?= $i ?>">Horas Practicas Presenciales:</label>
                                                        <input type="number" class="form-control pull-right" id="dpd_hp_hp_<?= $i ?>" name="dpd_hp_hp_<?= $i ?>" min="0">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="dpd_hp_hl_<?= $i ?>">Horas Laboratorio Presenciales:</label>
                                                        <input type="number" class="form-control pull-right" id="dpd_hp_hl_<?= $i ?>" name="dpd_hp_hl_<?= $i ?>" min="0">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="dpd_hp_ha_<?= $i ?>">Horas Ayudantia Presenciales:</label>
                                                        <input type="number" class="form-control pull-right" id="dpd_hp_ha_<?= $i ?>" name="dpd_hp_ha_<?= $i ?>" min="0">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="dpd_ha_ht_<?= $i ?>">Horas Teoricas Autonomas:</label>
                                                        <input type="number" class="form-control pull-right" id="dpd_ha_ht_<?= $i ?>" name="dpd_ha_ht_<?= $i ?>" min="0">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="dpd_ha_hp_<?= $i ?>">Horas Practicas Autonomas:</label>
                                                        <input type="number" class="form-control pull-right" id="dpd_ha_hp_<?= $i ?>" name="dpd_ha_hp_<?= $i ?>" min="0">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="dpd_ha_hl_<?= $i ?>">Horas Laboratorio Autonomas:</label>
                                                        <input type="number" class="form-control pull-right" id="dpd_ha_hl_<?= $i ?>" name="dpd_ha_hl_<?= $i ?>" min="0">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="dpd_ha_ha_<?= $i ?>">Horas Ayudantia Autonomas:</label>
                                                        <input type="number" class="form-control pull-right" id="dpd_ha_ha_<?= $i ?>" name="dpd_ha_ha_<?= $i ?>" min="0">
                                                    </div>
