    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                ...
                                <div class="box-footer">                                                                        
                                    <a href="verProgramaExtensoAsignaturasDirectiva.php?pe_id=<?= $pe_id ?>" style="margin-right: 10px;" class="btn btn-default pull-right"><i class="glyphicon glyphicon-arrow-left"></i> Volver Atras</a>&nbsp;&nbsp;
                                </div>
                                <!-- /.box-footer -->
                            </div>
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h4>La asignatura no tiene un programa guia didáctico creado..</h4>
                    </div>
        ...
        <script>
                            ...
                            function buscarProgramasDidactico() {
                                var pe_id = $('#pe_id').val();
                                $.get("../Servlet/administrarPrograma_didactico.php", {accion: 'BUSCAR_BY_PE_ID_AND_ESTADO', pe_id: pe_id, estado: 0}, function (data) {
                                    if (data.length > 0) {
                            ...
                            function ver(pd_id) {
                                window.location = "verProgramaDidacticoAsignaturasDirectiva.php?pd_id=" + pd_id;
                            }
        </script>
    </body>
</html>
